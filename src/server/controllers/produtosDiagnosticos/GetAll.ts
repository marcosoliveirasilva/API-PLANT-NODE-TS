...
export const getAll = async (req: Request<{}, {}, {}, IQueryProps>, res: Response) => {
  const result = await produtosDiagnosticos.Provider.getAll(
    req.query.page || 1,
    req.query.limit || 7,
  ...
  const count = await produtosDiagnosticos.Provider.count(req.query.productID, req.query.diagnosticID);
